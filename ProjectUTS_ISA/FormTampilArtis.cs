...
{
    public partial class FormTampilArtis : Form
    {
        public FormTampilArtis()
        {
            InitializeComponent();
        }
        ...
        private void FormTampilArtis_Load(object sender, EventArgs e)
        {
            FormatDataGrid();
        ...
        private void FormatDataGrid()
        {
            ...
            dataGridViewArtis.Columns.Add("manajer", "Manajer");
            ...
            dataGridViewArtis.Columns["manajer"].AutoSizeMode = DataGridViewAutoSizeColumnMode.AllCells;
        ...
        private void TampilDataGrid()
        {
            ...
            if (listArtis.Count > 0)
            {
                ...
                {
                    dataGridViewArtis.Rows.Add(a.Id, a.Nama, a.Email, a.NoTelp, a.Manajer.Nama);
                }
            }
            else
            {
